...
struct BattleState::Entity { EntityId id{}; Kind kind{}; Side side{}; int level{}; Vec2 pos{}; double hp{}, max_hp{}; double damage{}, healing{}, death_damage{}, death_splash_radius{}, trigger_range{}, range{}, min_range{}, speed{}, radius{}, splash_radius{}; Milliseconds cooldown{}, next_action{}, next_path{}, time_between_bursts{}, death_damage_delay{}, invisible_to_defenses_until{}, inferno_lock_elapsed{}, next_aura_action{}, deployment_rage_until{}; EntityId inferno_lock_target{}; int activation_housing{}, shots_per_burst{1}, shots_in_burst{}, earthquake_hits{}, multi_target_count{}, opening_long_shots_remaining{}; bool ranged{}, splash{}, flying{}, heals{}, concealed{}, supercharged{}, underground{}; TargetFocus target_focus{TargetFocus::Any}; TargetType target_type{TargetType::Ground}; bool defenses{}; std::optional<EntityId> target; std::optional<Vec2> waypoint; };
